...
The `@nfq/no-magic-numbers` rule aims to make code more readable and refactoring easier by ensuring that special numbers
...
```js
/*eslint @nfq/no-magic-numbers: "error"*/
...
```js
/*eslint @nfq/no-magic-numbers: ["error", { "ignore": [1] }]*/
...
```js
/*eslint @nfq/no-magic-numbers: ["error", { "ignore": ["1n"] }]*/
...
```js
/*eslint @nfq/no-magic-numbers: ["error", { "ignoreArrayIndexes": true }]*/
...
```js
/*eslint @nfq/no-magic-numbers: ["error", { "ignoreDefaultValues": true }]*/
...
A boolean to specify if numbers used in array literals are considered okay. `false` by default.

Examples of **correct** code for the `{ "ignoreArrays": true }` option:

::: correct

```js
/*eslint @nfq/no-magic-numbers: ["error", { "ignoreArrays": true }]*/
...
A boolean to specify if numeric `const` declarations are considered okay. `false` by default.

Examples of **correct** code for the `{ "ignoreConstDeclarations": true }` option:

::: correct

```js
/*eslint @nfq/no-magic-numbers: ["error", { "ignoreConstDeclarations": true }]*/
...
An array of function names in which numeric literals are allowed. Default: `[]`.

Examples of **correct** code for the `{ "ignoreFunctions": ["spacing"] }` option:

::: correct

```js
/*eslint @nfq/no-magic-numbers: ["error", { "ignoreFunctions": ["spacing"] }]*/
...
```js
/*eslint @nfq/no-magic-numbers: ["error", { "ignoreClassFieldInitialValues": true }]*/
...
```js
/*eslint @nfq/no-magic-numbers: ["error", { "enforceConst": true }]*/
...
```js
/*eslint @nfq/no-magic-numbers: ["error", { "detectObjects": true }]*/
...
```ts
/*eslint @nfq/no-magic-numbers: ["error", { "ignoreEnums": false }]*/
...
```ts
/*eslint @nfq/no-magic-numbers: ["error", { "ignoreEnums": true }]*/
...
```ts
/*eslint @nfq/no-magic-numbers: ["error", { "ignoreNumericLiteralTypes": false }]*/
...
```ts
/*eslint @nfq/no-magic-numbers: ["error", { "ignoreNumericLiteralTypes": true }]*/
...
```ts
/*eslint @nfq/no-magic-numbers: ["error", { "ignoreReadonlyClassProperties": false }]*/
...
```ts
/*eslint @nfq/no-magic-numbers: ["error", { "ignoreReadonlyClassProperties": true }]*/
...
```ts
/*eslint @nfq/no-magic-numbers: ["error", { "ignoreTypeIndexes": false }]*/
...
```ts
/*eslint @nfq/no-magic-numbers: ["error", { "ignoreTypeIndexes": true }]*/
